...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.4375, 537.0, 97.0, 24.0 ],
					"style" : "",
					"text" : "prepend store"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 16.4375, 504.0, 105.0, 24.0 ],
					"style" : "",
					"text" : "route obj-name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.4375, 546.0, 74.0, 24.0 ],
					"style" : "",
					"text" : "writeagain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.5, 504.0, 63.0, 24.0 ],
					"style" : "",
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.5, 515.0, 68.0, 24.0 ],
					"style" : "",
					"text" : "sort -1 -1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 251.0, 469.0, 38.0, 24.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.4375, 469.0, 152.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 16.4375, 588.0, 140.0, 24.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
					"style" : "",
					"text" : "coll mp-helper.coll"
				}
...
,
					"patching_rect" : [ 371.5625, 556.5, 82.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"id" : "obj-34",
					"ignoreclick" : 1,
					"items" : [ ",", "Launch html reference page for mp.super_module", ",", "Launch LAM.lib overview patch", ",", "Credits and acknowledgements", ",", "Show the bug tracker entries for mp.super_module", ",", "How to report a bug?", ",", "..." ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 473.0, 564.0, 93.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.0625, 151.75, 191.0, 29.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0625, 177.75, 191.0, 29.0 ],
					"style" : "",
					"text" : ";\rmax launchbrowser http://www.lam.jussieu.fr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.4375, 367.0, 168.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.4375, 367.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 8.4375, 268.0, 523.0, 22.0 ],
					"style" : "",
					"text" : "patcherargs @obj-name mp.super_module @obj-desc \"A modular polyphony lib\" @width 800"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.4375, 367.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 8.4375, 333.0, 241.0, 22.0 ],
					"style" : "",
