...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 460.0, 490.0, 50.0 ],
					"style" : "",
					"text" : "Note: When using in Windows, imp.midiin cannot use any port that the host application (Max or Ableton Live) is also using. Any ports required to be used with imp.midiin should be disabled in Max/Ableton MIDI preferences.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 410.0, 270.0, 40.0 ],
					"style" : "",
					"text" : "Outputs 1 if port is succesfully connected, 0 if there is an error or the port is in use",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 170.0, 420.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 100.0, 410.0, 65.0 ],
					"style" : "",
					"text" : "Works identically to midiin, with the additional of a connection status outlet.Listen to a specific MIDI port and output the raw MIDI data received. Allows access to any MIDI port when used inside Max For Live devices.",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 53.0, 172.0, 247.0, 21.0 ],
					"style" : "",
					"text" : "double click to select port (Windows only)",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 220.0, 350.0, 196.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.5, 253.0, 292.5, 65.0 ],
					"style" : "",
					"text" : "imp.midiin produces MIDI messages as a series of individual bytes, and is useful as input to objects like midiparse, seq, xnotein, xbendin and midiselect",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 140.0, 200.0, 80.0, 23.0 ],
					"style" : "",
					"text" : "imp.midiin b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 50.0, 200.0, 80.0, 23.0 ],
					"style" : "",
					"text" : "imp.midiin a"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 320.0, 80.0, 23.0 ],
					"style" : "",
					"text" : "imp.midiinfo"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-22",
					"items" : [ "IAC Driver Internal MSC", ",", "IAC Driver Internal MTC", ",", "to Max 1", ",", "to Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 350.0, 158.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 250.0, 73.0, 23.0 ],
					"style" : "",
					"text" : "print port A"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 250.0, 74.0, 23.0 ],
					"style" : "",
					"text" : "print port B"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 290.0, 77.0, 23.0 ],
					"style" : "",
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 420.0, 36.0, 23.0 ],
					"style" : "",
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 120.0, 390.0, 69.0, 23.0 ],
					"style" : "",
					"text" : "imp.midiin"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.0, 200.0, 163.103668, 39.0 ],
					"presentation_rect" : [ 240.0, 200.0, 163.103668, 39.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 24.0, 172.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
