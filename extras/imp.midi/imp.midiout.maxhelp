...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 430.0, 501.0, 50.0 ],
					"style" : "",
					"text" : "Note: When using in Windows, imp.midiout cannot use any port that the host application (Max or Ableton Live) is also using. Any ports required to be used with imp.midiout should be disabled in Max/Ableton MIDI preferences.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 380.0, 270.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.0, 390.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 230.0, 158.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 200.0, 105.0, 25.0 ],
					"style" : "",
					"text" : "stop the note",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 170.0, 94.0, 25.0 ],
					"style" : "",
					"text" : "start a note",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 200.0, 68.0, 23.0 ],
					"style" : "",
					"text" : "144, 60, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 170.0, 77.0, 23.0 ],
					"style" : "",
					"text" : "144, 60, 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 230.0, 45.0, 23.0 ],
					"style" : "",
					"text" : "port a"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 230.0, 20.0, 23.0 ],
					"style" : "",
					"text" : "b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 50.0, 310.0, 77.0, 23.0 ],
					"style" : "",
					"text" : "imp.midiout"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 140.0, 310.0, 175.838318, 54.0 ],
					"presentation_rect" : [ 140.0, 310.0, 175.838318, 54.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 100.0, 400.0, 50.0 ],
					"style" : "",
					"text" : "Works identically to midiout, with the additional of a connection status outlet. Transmits raw MIDI data to a specified port. Allows access to any MIDI port when used inside Max For Live devices.",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
